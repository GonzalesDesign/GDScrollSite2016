...
(function () { //IIFE:Immediately-Invoked Function Expression
  ...
  var mediumHeight = 520; //440;
  var smallHeight = 440; //370; //768;
  ...
  function fMediaQueries () {
    ...
    if (winWidth <= 512) {
      ...
      for (var i = 0; i < aRightColumns.length; i++) {
        aRightColumns[i].css ({"width": "90%"}); //33.33333333%;
      }
   ...
   * Add
   **************************************************************************/
  var ulRowImg1Width = (rowImgRightColmnWidth + 200) * aR2Images.length;
  ...
  rightArrow.click (function () {
    ...
    currentImageXpos = nextPos;
    console.log ("currentImageXpos: ", currentImageXpos);
