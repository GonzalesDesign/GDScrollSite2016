...
(function () { //IIFE:Immediately-Invoked Function Expression
  ...
  function fRow2Columns (){
    var colOne = winWidth/9;
    var colTwo = winWidth - colOne;
    rowImgRightColmnWidth = colTwo;
  ...
  rowImgRightColmnWidth = $ (rowImgRightColmn).width ();
  var origWidth = 544; //Image original width
   var origHeight = 438; //Image original height
  var imgSizePercentage2 =  rowImgRightColmnWidth/origWidth; //Current right column image width / image orig width
  var imgRowHeight = (origHeight * imgSizePercentage2); //Applying the same percentage for the height
  console.log ("Init load: rowImgRightColmnWidth:----- " + rowImgRightColmnWidth);
  //console.log ("imgSizePercentage1:----- " + imgSizePercentage1);
  console.log ("imgSizePercentage2:----- " + imgSizePercentage2);
  ...
  function fMediaQueries () {
    ...
    //fSlider (ulRowImg1, elemPosition);
    ...
    ulRowImg1Width = (rowImgRightColmnWidth * aR2Images.length) + 100;
    ulRowImg1.css ({"width": ulRowImg1Width});
    console.log ("rowImgRightColmnWidth: ", rowImgRightColmnWidth);
    console.log ("ulRowImg1Width: ", ulRowImg1Width);
    console.log ("-----------------------------------------•: ");
    ...
    if (winWidth <= 480) {
      ...
      for (var i = 0; i < aR2Images.length; i++) {
        fAnimateHeightWidth (aR2Images, smallHeight, winWidth90); //rowImgRightColmnWidth);
      }
    ...
    /**-------------===========( Smartphones Viewport: 480 - 640 )===========-------------**/
      ...
      /*var origWidth = 544; //Image original width
      var origHeight = 438; //Image original height*/
      //var imgSizePercentage1 =  origWidth/rowImgRightColmnWidth;
      imgSizePercentage2 =  rowImgRightColmnWidth/origWidth; //Current right column image width / image orig width
      imgRowHeight = (origHeight * imgSizePercentage2); //Applying the same percentage for the height
      console.log ("rowImgRightColmnWidth:----- " + rowImgRightColmnWidth);
      //console.log ("imgSizePercentage1:----- " + imgSizePercentage1);
      console.log ("imgSizePercentage2:----- " + imgSizePercentage2);
      console.log ("imgRowHeight:----- " + imgRowHeight);
