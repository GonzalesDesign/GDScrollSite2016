...
(function () { //IIFE:Immediately-Invoked Function Expression
  ...
  function fRow2Columns (windowWidth, dividerNum){
    console.log ("fRow2Columns function----------------: ");
    var colOne = windowWidth / dividerNum;
    var colTwo = windowWidth - colOne;
    var imageRightColumnWidth = Math.round(colTwo);;
    ...
    console.log ("End fRow2Columns function----------------: ");
  }
  ...
  var colRightCrop   = $ (".colRightCrop"); //Column right cropper
  ...
  console.log("colLeftWidth: ",colLeftWidth);
